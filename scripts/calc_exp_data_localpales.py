# code modified from here: https://github.com/paulrobustelli/Borthakur_MaxEnt_IDPs_2024/blob/main/calc_exp_data.py
import sys
import mdtraj as md
import os
import shutil
...
PALES_EXE = '/projects/lindorff_group/people/thd711/software/pales/linux/pales'
...
if(vars(args)['rdc']):
 ...
 valid_indices = []
 IDX=-1
 for name in resname[1:-1]:
   IDX+=1
   if name != "PRO":
     valid_indices.append(IDX)
 valid_indices = np.array(valid_indices)

 label = np.array(resnum)[1:-1][valid_indices]
